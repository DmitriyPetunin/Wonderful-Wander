...
sealed class ProfileAction {
    ...
    data class SubmitLikeMyPost(val postId:String):ProfileAction()
    data class SubmitLikeSavedPost(val postId:String):ProfileAction()
    data class SubmitSavePost(val postId:String):ProfileAction()
